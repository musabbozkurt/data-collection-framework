...
<?php if (isset($_SESSION['usr_id'])) { ?>
	<div class="arayuz_basliklar" style="margin-top:3%;">
            ...
            <div class="menu"> <a href="javascript:;" onclick="arayuz_degis('sekme4','STORING DATA','white');" style="color:white">Storing Data</a> </div>
		...
		<div class="arayuz_icerik sekme9" style="display: none;" >
			<form method="POST" action="index.php">
		    		<font color="white">How many tweets do you want to collect? :</font> <input type="text" 					name="numberoftweet" id="numberoftweet"> <br><br>
		...
		<div class="arayuz_icerik sekme10" style="display: none;">
			<form method="POST" action="index.php">
					<font color="white">Please enter username :</font> <input type="text" name="username" id="username"> <br><br>
		    		<font color="white">How many tweets do you want to collect? :</font> <input type="text" name="numberoftweet" id="numberoftweet"> <br><br>
		...
		<form method="POST" action="index.php">
		    <font color="white">Please Enter Database Name :</font> <input type="text" name="databasename" id="databasename"> <br><br>
		    <font color="white">Please Enter Collection Name :</font> <input type="text" name="collectionname" id="collectionname"> <br><br>
		    <font color="white">Store your data to Mongo Database make sure your path is okay or change it from config file<br></font>
	...
	<div class="arayuz_icerik sekme5" style="display: none;" >
		...
		<div class="arayuz_icerik sekme13" style="display: none;" >
			<form method="POST" action="index.php">
			    <font color="white">How many bars do you want to see in your plot? :</font> <input type="text" 			        name="numberofbar" id="numberofbar"> <br><br>
	...
	<div class="arayuz_icerik sekme6" style="display: none;" >
		<div class="menu" style="margin-top:150px;"> <a href="javascript:;" onclick="arayuz_degis('sekme28','UserList','white');" style="color:white">Stream From Word List</a> </div>
            <div class="menu"> <a href="javascript:;" onclick="arayuz_degis('sekme29','UserName','white');" style="color:white">Stream From Word Input</a> </div>
	</div>
		...
		<div class="arayuz_icerik sekme28" style="display: none;">
		        <form method="POST" action="index.php">
		            <font color="white">Please Enter Database Name :</font> <input type="text" name="databasename" id="databasename"> <br><br>
		    	    <font color="white">Please Enter Collection Name :</font> <input type="text" name="collectionname" id="collectionname"> <br><br>
		    	    <font color="white">Please Enter File Name :</font> <input type="text" name="filename" id="filename"> <br><br>
			    	<font color="white">Please Enter Finishing Date as "Year-Month-Day Hour:Minute:Second"(Ex:2016-12-30 15:27:30) :</font> <input type="text" name="finishingdate" id="finishingdate"> <br><br>
		...
		<div class="arayuz_icerik sekme29" style="display: none;">
		        <form method="POST" action="index.php">
		    	    ...
		    	    <font color="white">Please Enter File Name :</font> <input type="text" name="filename" id="filename"> <br><br>
			    	<font color="white">Please Enter Finishing Date as "Year-Month-Day Hour:Minute:Second"(Ex:2016-12-30 15:27:30) :</font> <input type="text" name="finishingdate" id="finishingdate"> <br><br>
			    	<font color="white">Please Enter a word, hashtag or something else for filter :</font> <input type="text" name="filterword" id="filterword"> <br><br>
	...
	<div class="arayuz_icerik sekme7" style="display: none;" >
		<form method="POST" action="index.php">
		    <font color="white">Enter number for N for cross validation? :</font> <input type="text" name="nforcross" id="nforcross"> <br><br>
		    <font color="white">Enter number of split? :</font> <input type="text" name="numberofsplit" id="numberofsplit"> <br><br>
		    <font color="white">Enter number for test size between 0 and 1? it might be 0.3 :</font> <input type="text" name="testsize" id="testsize"> <br><br>
		    <font color="white">Enter random state you might enter 0(zero)? :</font> <input type="text" name="randomstate" id="randomstate"> <br><br>
		    <font color="white">Enter number for test size between 0 and 1 for train test? you might enter 0.4 or 0.6 :</font> <input type="text" name="traintest" id="traintest"> <br><br>
		    <font color="white">Enter number for C for kernel in svc you might enter 1(one)? :</font> <input type="text" name="numberforc" id="numberforc"> <br><br>
	...
	<div class="arayuz_icerik sekme8" style="display: none;" >
		<form method="POST" action="index.php">
		    <font color="white">Enter number to display the most frequent words (or tokens), are not exactly meaningful :</font> <input type="text" name="frequentword" id="frequentword"> <br><br>
		    <font color="white">Enter number to print top of maximum term :</font> <input type="text" name="topofmax" id="topofmax"> <br><br>
		    <font color="white">Enter a word, hashtag or something else to find Co-occurrence :</font> <input type="text" name="cooccurance" id="cooccurance"> <br><br>
