...
<?php if (isset($_SESSION['usr_id'])) { ?>
    <div class="arayuz_basliklar" style="margin-top:3%;">
        ...
        <div class="menu"><a href="javascript:" onclick="arayuz_degis('sekme4','STRORING DATA','white');"
    ...
    <fieldset>
        ...
        <div class="arayuz_icerik sekme9" style="display: none;">
            <form method="POST" action="client.php">
                How many tweets do you want to collect? : <input type="text" name="numberoftweet" id="numberoftweet">
                <br><br>
        ...
        <div class="arayuz_icerik sekme13" style="display: none;">
            <form method="POST" action="client.php">
                How many bars do you want to see in your plot? : <input type="text" name="numberofbar" id="numberofbar">
                <br><br>
        ...
        <div class="arayuz_icerik sekme6" style="display: none;">
            <form method="POST" action="client.php">
                ...
                Please Enter Finishing Date as "Year-Month-Day Hour:Minute:Second"(Ex:2016-12-30 15:27:30) : <input
                        type="text" name="finishingdate" id="finishingdate"> <br><br>
                Please Enter a word, hashtag or something else for filter : <input type="text" name="filterword"
                                                                                   id="filterword"> <br><br>
        ...
        <div class="arayuz_icerik sekme7" style="display: none;">
            <form method="POST" action="client.php">
                ...
                Enter number for test size between 0 and 1? it might be 0.3 : <input type="text" name="testsize"
                                                                                     id="testsize"> <br><br>
                Enter random state you might enter 0(zero)? : <input type="text" name="randomstate" id="randomstate">
                <br><br>
                Enter number for test size between 0 and 1 for train test? you might enter 0.4 or 0.6 : <input
                        type="text" name="traintest" id="traintest"> <br><br>
                Enter number for C for kernel in svc you might enter 1(one)? : <input type="text" name="numberforc"
                                                                                      id="numberforc"> <br><br>
        ...
        <div class="arayuz_icerik sekme8" style="display: none;">
            <form method="POST" action="client.php">
                Enter number to display the most frequent words (or tokens), are not exactly meaningful : <input
                        type="text" name="frequentword" id="frequentword"> <br><br>
                Enter number to print top of maximum term : <input type="text" name="topofmax" id="topofmax"> <br><br>
                Enter a word, hashtag or something else to find Co-occurrence : <input type="text" name="cooccurance"
                                                                                       id="cooccurance"> <br><br>
